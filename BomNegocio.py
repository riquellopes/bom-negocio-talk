...
class BomNegocioException(Exception):
	pass
...
def query_string(func):
	...
	def wrapper(self, *args, **kwargs):
		...
		if q is not None:
			...
			raise BomNegocioException("Nenhum valor foi passado para o BomNegócio.")
...
class BomNegocio(object):
	...
	@property	
	def url(self):
		return 'http://{0}.bomnegocio.com/{1}'.format(self.cidade, self.categoria)	
...
if __name__ == '__main__':
	bom = BomNegocio(BOM_NEGOCIO_CIDADE.RJ, BOM_NEGOCIO_CATEGORIA.INSTRUMENTOS_MUSICAIS)
